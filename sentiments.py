...
class SentimentAnalysis:
    ...
    def DownloadData(self, keyword, tweets):
        ...
        # authenticating
        consumerKey = "hPs8fXgvE7PrEItSUUBO6foXo"
        consumerSecret = "1jOA6NttngE17yI1NuY9WtwP8mUfNG0dHba9vy9lFn72GaOn5L"
        accessToken = "1456553786550456324-cZ2FFt2N5FhiI7KtlUEbYTTzRWu31R"
        accessTokenSecret = "xf8IHwbMX9HXZXOFn8NbWQwGxnmTKKDLV1HF5rQshqJLP"
    ...
    def plotPieChart(self, positive, wpositive, spositive, negative, wnegative, snegative, neutral, keyword, tweets):
        ...
        plt.axis('equal')
        plt.tight_layout()
        strFile = r"C:\Users\MVP\PycharmProjects\pythonProject2\static\images\plot3.png"
